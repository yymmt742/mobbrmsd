!| generates an orthogonal matrix that reducing a real matrix to bidiagonal.
!
!  mobbrmsd_DORGBR generates one of the real orthogonal matrices
!  \(Q\) or \(P^\top\)
!  determined by mobbrmsd_DGEBRD when reducing a real matrix \( A \)
!  to bidiagonal form:
!  \( A = Q B P ^ \top \).
