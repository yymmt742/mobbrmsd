!| mobbrmsd_SGEQR2 computes the QR factorization of a general rectangular matrix using an unblocked algorithm.
!
...
!  and tau in TAU(i).
!
!  Reference SGEQR2 is provided by [netlib.org](http://www.netlib.org/lapack/).
!
