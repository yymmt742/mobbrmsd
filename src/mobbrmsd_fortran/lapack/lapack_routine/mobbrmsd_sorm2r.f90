...
!
!  mobbrmsd_SORM2R multiplies a general matrix by the orthogonal matrix
!  from a QR factorization determined by mobbrmsd_SGEQRF.
...
!     December 2016
!
pure subroutine mobbrmsd_SORM2R(SIDE, TRANS, M, N, K, A, LDA, TAU, &
     &                          C, LDC, WORK, INFO)
  implicit none
