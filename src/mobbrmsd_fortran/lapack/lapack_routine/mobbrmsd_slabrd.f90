!| mobbrmsd_SLABRD reduces the first \( nb \)  rows and columns of
...
!  \]
!
!  Reference SLABRD is provided by [netlib](http://www.netlib.org/lapack/explore-html/).
!
