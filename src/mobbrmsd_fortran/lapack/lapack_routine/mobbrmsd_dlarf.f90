!| mobbrmsd_DLARF applies an elementary reflector to a general rectangular matrix.
!
...
!
!  Reference DLARF is provided by [netlib](http://www.netlib.org/lapack/explore-html/).
!
