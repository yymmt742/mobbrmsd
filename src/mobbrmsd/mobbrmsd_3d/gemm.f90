!| DGEMM for d=3. (N, M, and K are provided for compatibility with BLAS and are not used here.) <br>
...
pure subroutine DGEMM(TRANSA, TRANSB, M, N, K, ALPHA, A, LDA, B, LDB, BETA, C, LDC)
  ...
  if (TRANSA=='T') then
    if (TRANSB=='T') then
      ...
      C(2, 1) = A(1, 2) * B(1, 1) + A(2, 2) * B(1, 2) + A(3, 2) * B(1, 3)
      C(3, 1) = A(1, 3) * B(1, 1) + A(2, 3) * B(1, 2) + A(3, 3) * B(1, 3)
      C(1, 2) = A(1, 1) * B(2, 1) + A(2, 1) * B(2, 2) + A(3, 1) * B(2, 3)
      C(2, 2) = A(1, 2) * B(2, 1) + A(2, 2) * B(2, 2) + A(3, 2) * B(2, 3)
      C(3, 2) = A(1, 3) * B(2, 1) + A(2, 3) * B(2, 2) + A(3, 3) * B(2, 3)
      C(1, 3) = A(1, 1) * B(3, 1) + A(2, 1) * B(3, 2) + A(3, 1) * B(3, 3)
      C(2, 3) = A(1, 2) * B(3, 1) + A(2, 2) * B(3, 2) + A(3, 2) * B(3, 3)
