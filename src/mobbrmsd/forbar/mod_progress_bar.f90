...
!| Unicode character LIGHT_SHADE
  ...
  integer, parameter  :: LEN_LIGHT_SHADE          = LEN(LIGHT_SHADE)
  integer, parameter  :: LEN_MEDIUM_SHADE         = LEN(MEDIUM_SHADE)
  integer, parameter  :: LEN_DARK_SHADE           = LEN(DARK_SHADE)
!
...
!
  pure subroutine composite_bar(l, p, limit, prog, cmid, ifmt, layer, res)
    integer, intent(in)         :: l, p, limit, prog
