!| mobbrmsd_DGEBRD reduces a general real \( M \) -by- \( N \) matrix
...
!
!  Reference DGEBRD is provided by [netlib](http://www.netlib.org/lapack/explore-html/).
!
...
!!  DOUBLE PRECISION array, dimension (min(M,N)-1)
!!
