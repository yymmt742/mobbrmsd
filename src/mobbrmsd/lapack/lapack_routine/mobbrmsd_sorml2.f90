...
!
!  mobbrmsd_SORML2 multiplies a general matrix by the orthogonal matrix
!  from a LQ factorization determined by mobbrmsd_SGELQF (unblocked algorithm).
!
...
!
!  Reference SORML2 is provided by [netlib](http://www.netlib.org/lapack/explore-html/).
!
